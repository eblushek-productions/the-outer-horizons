...
public sealed partial class ShuttleConsoleWindow : BaseWindow,
    IComputerWindow<ShuttleBoundUserInterfaceState>
{
    ...
    public ShuttleConsoleWindow()
    {
        ...
        ThrusterInfoModeButton.OnPressed += ThrusterPressed;

        NavModeButton.Label.AddStyleClass("ConsoleText");
        MapModeButton.Label.AddStyleClass("ConsoleText");
        DockModeButton.Label.AddStyleClass("ConsoleText");
        ...
        ThrusterInfoModeButton.Group = group;
    ...
    private void ClearModes(ShuttleConsoleMode mode)
    {
        ...
        if (mode != ShuttleConsoleMode.Thrusters)
        {
            ThrusterInfoContainer.Visible = false;
        }
    }
    ...
    private void ThrusterPressed(BaseButton.ButtonEventArgs obj)
    {
        SwitchMode(ShuttleConsoleMode.Thrusters);
    }
    ...
    private void SetupMode(ShuttleConsoleMode mode)
    {
        switch (mode)
        {
            ...
            case ShuttleConsoleMode.Dock:
                ...
                break;
            case ShuttleConsoleMode.Thrusters:
                ThrusterInfoContainer.Visible = true;
                break;
            default:
    ...
    public void OnSendMessage(ThrusterChangedMessage msg)
    {
        ThrusterInfoContainer.SetState(msg.ThrusterInfoState);
    }
