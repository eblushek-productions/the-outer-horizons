...
game-ticker-get-info-text =
    Номер раунда: [color=white]#{ $roundId }[/color]. Кол-во игроков: [color=white]{ $playerCount }[/color]
    Карта: [color=white]{ $mapName }[/color]. Режим игры: [color=white]{ $gmTitle }[/color]
    >[color=yellow]{ $desc }[/color]
game-ticker-get-info-preround-text =
    Номер раунда: [color=white]#{ $roundId }[/color]. Кол-во игроков: [color=white]{ $playerCount }[/color], ([color=white]{ $readyCount }[/color] { $readyCount ->
        [one] готов
       *[other] готовы
    })
    Карта: [color=white]{ $mapName }[/color]. Режим игры: [color=white]{ $gmTitle }[/color]
