construction-graph-tag-motor = мотор

construction-graph-tag-copperchamber = медная камера
construction-graph-tag-heatchamber = теплоустойчивая камера

construction-graph-tag-analogboard = аналоговая плата
construction-graph-tag-crtscreen = экран
