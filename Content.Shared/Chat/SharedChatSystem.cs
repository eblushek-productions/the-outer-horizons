...
public abstract partial class SharedChatSystem : EntitySystem
{
    ...
    public const char LOOCPrefix = '_'; // OH14-Changes, locale
    public const char OOCPrefix = '[';
    public const char EmotesPrefix = '%'; // OH14-Changes, locale
    public const char EmotesAltPrefix = '*';
    public const char AdminPrefix = ']';
    public const char WhisperPrefix = ',';
    public const char DefaultChannelKey = 'р'; // OH14-Changes, locale
